...
cat(log(rev(seq(500,180000000,length.out=length(sizes)))), file = outfile, append = TRUE,"\n")
cat("# log_n_mat", file = outfile, append = TRUE,"\n")
cat(rep(log(180000000),length(sizes)), file = outfile, append = TRUE,"\n")
