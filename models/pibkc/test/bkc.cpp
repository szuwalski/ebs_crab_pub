 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  rec_devs.allocate(styr,endyr,-20,20,1,"rec_devs");
  ...
  fish_tot_sel_50.allocate(25,150,-1,"fish_tot_sel_50");
  fish_tot_sel_slope.allocate(0.0001,20,-1,"fish_tot_sel_slope");
  ...
  #endif
  pred_retained_bio.allocate(styr,endyr,"pred_retained_bio");
  #ifndef NO_AD_INITIALIZE
...
void model_parameters::userfunction(void)
{
  f =0.0;
 dvariable fpen=0.0;
 cout<<molt_sel_50<<"molt_sel_50"<<endl;
