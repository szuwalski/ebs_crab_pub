DATA_SECTION
 ...
 !! ad_comm::change_datafile_name("catch_dat.DAT");
  ...
  init_int ret_cat_size_yr_n
  init_vector ret_cat_size_yrs(1,ret_cat_size_yr_n)
  init_matrix ret_cat_size(1,ret_cat_size_yr_n,1,size_n)
  
  init_int tot_cat_yr_n
  init_vector tot_cat_yrs(1,tot_cat_yr_n)
  init_vector tot_cat_numbers(1,tot_cat_yr_n)
  
  init_int tot_cat_size_yr_n
  init_vector tot_cat_size_yrs(1,tot_cat_size_yr_n)
  init_matrix tot_cat_size(1,tot_cat_size_yr_n,1,size_n) 
...
PARAMETER_SECTION
  ...
  // init_bounded_number surv_beta2(25,150,est_sel)
   ...
   init_bounded_number surv_q(0,1,est_q)
